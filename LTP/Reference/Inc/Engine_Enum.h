...
namespace Engine {
	...
	enum CHANNELID { CHANNEL_PLAYER, CHANNEL_MONSTER, CHANNEL_MAPOBJECT, CHANNEL_EFFECT, CHANNEL_UI, CHANNEL_SUBEFFECT, CHANNEL_TEMP, CHANNEL_BGM, CHANNEL_MAXCHANNEL };
