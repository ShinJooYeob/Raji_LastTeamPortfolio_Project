...
namespace Engine {
	...
	{
		POSTPROCESSING_DEBUGTARGET, POSTPROCESSING_DEBUGCOLLIDER,POSTPROCESSING_SHADOW, POSTPROCESSING_BLOOM, POSTPROCESSING_DOF, POSTPROCESSING_VOLUMATRIC, POSTPROCESSING_GODRAY, POSTPROCESSING_END
	};
