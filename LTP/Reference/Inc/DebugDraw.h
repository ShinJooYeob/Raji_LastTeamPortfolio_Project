...
namespace DX
{
    void ENGINE_DLL XM_CALLCONV  Draw(DirectX::PrimitiveBatch<DirectX::VertexPositionColor>* batch,
    ...
    void ENGINE_DLL XM_CALLCONV  DrawGrid(DirectX::PrimitiveBatch<DirectX::VertexPositionColor>* batch,
    ...
    void ENGINE_DLL XM_CALLCONV  DrawRing(DirectX::PrimitiveBatch<DirectX::VertexPositionColor>* batch,
    ...
    void ENGINE_DLL XM_CALLCONV  DrawTriangle(DirectX::PrimitiveBatch<DirectX::VertexPositionColor>* batch,
