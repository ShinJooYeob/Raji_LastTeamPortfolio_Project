...
class CDemonTreePuzzleTrigger final : public CTriggerObject
{
protected:
	CDemonTreePuzzleTrigger(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	CDemonTreePuzzleTrigger(const CDemonTreePuzzleTrigger& rhs);
	virtual ~CDemonTreePuzzleTrigger() = default;
...
public:
	static CDemonTreePuzzleTrigger*			Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, void* pArg = nullptr);
