...
{
public:
	enum EParkourTriggerType { PACUR_LEDGE, PACUR_JUMP, PACUR_CHANGE_NAV_INDEX, PACUR_PILLAR, BLOCK_ZONE, DEAD_ZONE, TRIGGER_CHANGE_CAMERA_VIEW, CHECK_POINT, PACUR_WALLRUN, TRIGGER_SCENECHANGE, PACUR_END };
