...
{
public:
	enum EParkourTriggerType { PACUR_LEDGE, PACUR_JUMP, PACUR_CHANGE_NAV_INDEX, PACUR_PILLAR, BLOCK_ZONE, DEAD_ZONE,  CHECK_POINT, PACUR_WALLRUN, TRIGGER_SCENECHANGE,TRIGGER_CHANGE_CAMERA_VIEW,INSTANCE_MONSTER, 
