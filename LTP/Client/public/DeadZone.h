...
class CDeadZone final : public CTriggerObject
{
protected:
	CDeadZone(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	CDeadZone(const CDeadZone& rhs);
	virtual ~CDeadZone() = default;
...
public:
	static CDeadZone*						Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, void* pArg = nullptr);
