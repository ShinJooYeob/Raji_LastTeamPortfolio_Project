...
class CScene_Minigame1 final : public CScene
{
private:
	explicit CScene_Minigame1(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext);
	virtual ~CScene_Minigame1() = default;
...
private:
	...
	HRESULT	Ready_Layer_MiniGame_Golu(const _tchar* pLayerTag);
...
public:
	static CScene_Minigame1* Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext);
