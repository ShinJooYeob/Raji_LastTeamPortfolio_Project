...
class CMonster_Wormgrub final : public CMonster
{
...
private:
	CMonster_Wormgrub(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	CMonster_Wormgrub(const CMonster_Wormgrub& rhs);
	virtual ~CMonster_Wormgrub() = default;
