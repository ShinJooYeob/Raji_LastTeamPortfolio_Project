...
HRESULT CCollider_PhysX_Dynamic ::Update_BeforeSimulation(CTransform* objTransform)
{
...
HRESULT CCollider_PhysX_Dynamic ::Update_AfterSimulation(CTransform* objTransform)
{
