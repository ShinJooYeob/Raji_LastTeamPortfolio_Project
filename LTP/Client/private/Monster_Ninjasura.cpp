...
HRESULT CMonster_Ninjasura::Once_AnimMotion(_double dDeltaTime)
{
	...
	case 0:
		...
		break;
	case 1:
		m_iOnceAnimNumber = 21;
		m_bComboAnimSwitch = true;
		break;
	case 2:
		m_iOnceAnimNumber = 22;
	...
	case 6:
		...
		break;
	case 7:
		m_iOnceAnimNumber = 4; //Rush start
		m_bComboAnimSwitch = false;
		break;
	case 8:
		m_iOnceAnimNumber = 19; //Ninjasura Bullet
		break;
	case 9:
	...
	case 12:
		...
		break;
	case 13:
		m_iOnceAnimNumber = 15; //Top Blade Ready
		m_bComboAnimSwitch = true;
		break;
	case 14:
		m_iOnceAnimNumber = 16; //Top Blade Start
		m_bComboAnimSwitch = true;
		break;
	case 15:
		m_iOnceAnimNumber = 17; //Top Blade ing~
		m_bComboAnimSwitch = true;
		break;
	case 16:
		m_iOnceAnimNumber = 16; //Top Blade ing~
		m_bComboAnimSwitch = true;
		break;
	case 17:
		m_iOnceAnimNumber = 18; //Top Blade End
		m_bComboAnimSwitch = false;
		break;
	}
	...
	if (PlayRate <= 0.98) //애니메이션의 비율 즉, 0.98은 거의 끝나가는 시점
	{
		...
		case 4:
		{
			...
			if (PlayRate <= 0.1)
			{
				...
				{
				case 0:
					m_pTransformCom->Move_Right(dDeltaTime * 10);
					break;
				case 1:
					m_pTransformCom->Move_Left(dDeltaTime * 10);
					break;
				default:
					break;
				}
