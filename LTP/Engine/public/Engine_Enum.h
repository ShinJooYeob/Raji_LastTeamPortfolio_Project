...
namespace Engine {
	...
	{
		POSTPROCESSING_DEBUGTARGET, POSTPROCESSING_DEBUGCOLLIDER,POSTPROCESSING_SHADOW, POSTPROCESSING_BLOOM, POSTPROCESSING_DOF, POSTPROCESSING_DDFOG, POSTPROCESSING_GODRAY, POSTPROCESSING_LENSEFLARE, POSTPROCESSING_END
	};
