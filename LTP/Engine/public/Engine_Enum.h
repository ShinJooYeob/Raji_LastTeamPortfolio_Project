...
namespace Engine {
	...
	{
		POSTPROCESSING_DEBUGTARGET, POSTPROCESSING_DEBUGCOLLIDER,POSTPROCESSING_SHADOW, POSTPROCESSING_BLOOM, POSTPROCESSING_DOF, 
	...
	enum TRANSFORMSTATETYPE { PLM_VIEW, PLM_PROJ, PLM_LIGHTVIEW, PLM_LIGHTPROJ, PLM_END };
	...
	enum COLLIDERTYPE_PhysXID { COLLIDER_PHYSX_TRIGGERIN, COLLIDER_PHYSX_TRIGGEROUT, 
		COLLIDER_PHYSX_CONECTIN, COLLIDER_PHYSX_CONECTSTAY, COLLIDER_PHYSX_CONECTOUT, COLLIDER_PHYSX_END};
